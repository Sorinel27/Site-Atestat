...
<body>
  ...
  <div class="asistenta">
    <div id="asistenta-text">
    In cazul in care aveti o problema sau o nedumerire cu privire la comanda dvs. nu ezitati sa trimiteti un e-mail la adresa support@bestpcs.ro.
    </div>
  </div>
	 <div id="downcredits">
      <div id = "cc1">
